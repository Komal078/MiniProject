...
<body class="doodle" background="Images/retail1.png">
...
<nav
		...
		<div class="navbar-brand">HDFC Bank</div>
			...
			<div style="margin: 5em 10em 2em 3em;">
				<div class="card  " style="width: 400px; background-color: #f3d8d8">
					<div class="card-body">
						...
						<br> <a href="/createCustomer" class="btn btn-secondary">Create</a>
					</div>
				...
				<div class="card" style="width: 400px; background-color: #f3d8d8">
					<div class="card-body">
						...
						<form action="/deleteCustomer" method="post">
							...
							<br> <br> <input type="submit" name="Delete" value="Delete" class="btn btn-danger" />
						</form>
				...
				<div class="card" style="width:400px;height:210px; background-color: #f3d8d8">
					<div class="card-body">
						...
						<form action="/deductServiceTax" method="post">
                         <input type="submit" name="View" value="Deduct" class="btn btn-warning" />
						</form>
