          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form:form action="/login" method="post" modelAttribute="login">
                 ...
                 <center> <input name="login" id="login" class="btn btn-primary login-btn mb-4" type="submit" value="Login"/></center>
                </form:form>
            ...
            <div class="col-md-5">
            <img src="Images/retail.jpg" alt="login" class="login-card-img">
          </div>
        </div>
      </div>
    </div>
