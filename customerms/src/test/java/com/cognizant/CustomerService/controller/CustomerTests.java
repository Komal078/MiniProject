...
@ContextConfiguration(classes = { CustomerServiceApplication.class })
 public class CustomerTests {
	...
	public void saveCustomers() throws JsonProcessingException, Exception {
		...
		String json = MAPPER.writeValueAsString(menu);
		MvcResult andReturn = mockMvc
				.perform(post("/saveCustomer").header("Authorization", "Bearer " + token)
						.content(json).contentType(MediaType.APPLICATION_JSON).accept(MediaType.APPLICATION_JSON)).andReturn();
	...
	public void getOneEmployees() throws JsonProcessingException, Exception {
		System.err.println(token);
		mockMvc.perform(MockMvcRequestBuilders.get("/getCustomerDetails/")
				.header("Authorization", "Bearer " + token).accept(MediaType.APPLICATION_JSON)).andReturn();
	...
	public void deleteEmployeeAPI() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.delete("/deleteCustomer").header("Authorization",
