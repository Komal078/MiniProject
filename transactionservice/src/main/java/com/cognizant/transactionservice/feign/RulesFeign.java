...
public interface RulesFeign {
	...
	public ResponseEntity<Object> evaluate(@RequestBody RulesInput account)throws MinimumBalanceException ;
	
	@PostMapping("/serviceCharges")
	public ResponseEntity<Object> serviceCharges(@RequestHeader("Authorization") String token,@RequestBody RulesInput account);
